...
release-cli --server-url https://git.magmafoundation.org --private-token=$TOKEN --project-id=$PROJECTID create --name "Magma $VERSION" --description "Magma Release" --tag-name "$SHA" --ref "$SHA" --assets-link "{\"url\":\"https://git.magmafoundation.org/api/v4/projects/5/packages/maven/org/magmafoundation/Magma/$VERSION/Magma-$VERSION-installer.jar\",\"name\":\"Magma-$VERSION-installer.jar\"}" --assets-link "{\"url\":\"https://git.magmafoundation.org/api/v4/projects/5/packages/maven/org/magmafoundation/Magma/$VERSION/Magma-$VERSION-server.jar\",\"name\":\"Magma-$VERSION-server.jar\"}"
